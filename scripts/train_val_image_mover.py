...
TRAIN_JSON_PATH = "C:\\Breathing_Bag_Defect\\Mask_RCNN\\Dataset_manual\\train.json"
VAL_JSON_PATH = "C:\\Breathing_Bag_Defect\\Mask_RCNN\\Dataset_manual\\val.json"

# Path to the directory where the images should be moved
TRAIN_DIR = "C:\\Breathing_Bag_Defect\\Mask_RCNN\\Dataset_manual\\train"
VAL_DIR = "C:\\Breathing_Bag_Defect\\Mask_RCNN\\Dataset_manual\\val"
